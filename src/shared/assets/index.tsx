...
export { default as IconAwards } from './components/IconAwards';
export { default as IconCircledright } from './components/IconCircledright';
export { default as IconDownbutton } from './components/IconDownbutton';
