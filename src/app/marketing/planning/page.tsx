import { ProjectGdgoc, ProjectSopt } from './_section';
...
const isTabValue = (value: string | undefined): value is TabValue =>
  value === 'sopt' || value === 'gdgoc';

type MarketingPlanningPageProps = {
  searchParams: Promise<{ tab?: string }>;
};

export default async function MarketingPlanningPage({ searchParams }: MarketingPlanningPageProps) {
  ...
  return (
    <div className='flex flex-col items-center gap-[10rem] max-lg:gap-[5rem]'>
      <section aria-labelledby='marketing-planning-project-title' className='max-lg:w-full'>
        <div className='flex flex-col items-center gap-[10rem] max-lg:gap-[5rem]'>
